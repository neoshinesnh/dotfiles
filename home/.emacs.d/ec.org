...
- [[https://www.huertatipografica.com/en/fonts/bitter-ht][Bitter Font]]
...
Change default font to [[https://sourcefoundry.org/hack/][ttf-hack]] and everything else to [[https://www.google.com/get/noto/][Noto]].
...
Add [[https://github.com/sabof/org-bullets][Org bullets]] to show bullets in outline and [[https://github.com/rnkn/olivetti][Olivetti]] to display a
better buffer layout.
...
#+BEGIN_SRC emacs-lisp
(let* ((variable-tuple
        (cond ((x-list-fonts "Bitter") '(:font "Bitter"))

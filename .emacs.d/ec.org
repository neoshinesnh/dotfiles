...
#+STARTUP: nodlcheck lognotestate showall
    ...
    -  [[#recommended-dependencies-and-setup][Recommended dependencies and setup]]
    -  [[#key-binds-table][Key-binds table]]
    -  [[#initialization-file-initel][Initialization file (init.el)]]
    -  [[#packages][Packages]]
    -  [[#requirements][Requirements]]
    -  [[#settings-for-built-in-stuff][Settings for built-in stuff]]
      -  [[#editor-enhancements][Editor enhancements]]
      -  [[#linux-tweaks][Linux tweaks]]
      -  [[#visual-settings][Visual settings]]
      -  [[#auto-completions][Auto completions]]
    -  [[#settings-for-external-stuff][Settings for external stuff]]
      -  [[#visual-settings][Visual settings]]
      -  [[#editor-enhancements][Editor enhancements]]
      -  [[#spell-and-code-check][Spell and code check]]
    ...
    -  [[#programming-languages][Programming languages]]
      ...
      -  [[#web-html-svelte-templates-inline-css-and-javascript][WEB (HTML, Svelte, Templates, inline CSS and Javascript)]]
      -  [[#css][CSS]]
      -  [[#json][JSON]]
      -  [[#yaml][YAML]]
      -  [[#php][PHP]]

...
#+BEGIN_SRC emacs-lisp
(setq org-ellipsis "⤵"                ;; make org ellipsis show as a arrow
      org-log-done 'time              ;; add time stamp in tasks that are done
      org-enforce-todo-dependencies t ;; don't let tasks that have undone subtasks to be done
      org-enforce-todo-checkbox-dependencies t
      org-default-notes-file (concat org-directory "/notes.org")
      org-agenda-files (list (concat org-directory "/general.org") (concat org-directory "/work.org")))
#+END_SRC

Set keybind for org-capture.

#+BEGIN_SRC emacs-lisp
(define-key global-map (kbd "C-c C-,") 'org-capture)
(define-key global-map (kbd "C-c C-/") 'org-agenda)
#+END_SRC

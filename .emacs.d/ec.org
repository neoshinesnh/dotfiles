...
- Download, install and add /quicklisp/ to /sbcl/ initialization.
...
#+BEGIN_SRC emacs-lisp
(defun my/spell-check (lang)
  "Define dictionary lang and check with flyspell"
  (ispell-change-dictionary lang)
  (flyspell-buffer))

(bind-key "C-c P" (lambda () (interactive) (my/spell-check "brasileiro")))
(bind-key "C-c E" (lambda () (interactive) (my/spell-check "american")))
#+END_SRC
...
(use-package flycheck
  ...
  (defun my/disable-flycheck-flawed-checkers ()
    "Disable jshint and jsonlist from flycheck"
...
(use-package markdown-mode
  ...
  (setq markdown-command my/pandoc-path
        markdown-css-paths my/markdown-css-path
        markdown-xhtml-header-content my/markdown-head))
...
(use-package racer
  ...
  (setq racer-cmd my/racer-path
        racer-rust-src-path my/rust-src-path))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(defun my/conf ()
  "Load the current emacs configuration org file (~/.emacs.d/ec.org)"
  (interactive)

...
variables and functions will have a prefix (my).
...
(setq user-full-name "Thiago Polastri"
      ...
      my/markdown-css-path '("/home/USER/.emacs.d/custom/styles/md.css")
      my/markdown-head "<style>/* any html head tag you want to export with md to html */</style>"
      ...
      my/wakatime-apikey "your-wakatime-api-key"
...
;; fix xdg-open by change process connection type to use pipe.
;; It will probably cause some side effects (eg. gnuplot)
;; you can comment this if you have any problems
